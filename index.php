...
<html class="no-js" lang="">
    <head>
        ...
        <script src="assets/js/jQuery-v3.1.1.js"></script><!--https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js-->
    </head>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand text-center" href="#">জীবনতরী</a>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
				<div class="col-md-4">
                    <div class="about-text">
                      <h4>Blood</h4>
                      <p>Blood is the red coloured fluid that flows continuously in a human being's circulatory system. Blood comprises more than 8% of the body weight of a healthy individual. On an average, every adult person has about 5 - 6 litres of blood.</p>
                      <p>The major component of blood is a fluid called plasma in which are suspended cellular elements. These are Red Blood Cells or RBC's, White Blood Cells or WBC's and tiny platelets.</p>	
					</div>
                </div>
                <div class="col-md-4">
                    <div class="about-text">
